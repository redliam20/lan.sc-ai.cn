...
export function getDataJsonFromExcel (file, callback) {
...
export function exportJson2Excel (th, jsonData, defaultTitle, defaultWsName) {
  /* original data */
  var data = jsonData
  data.unshift(th)
  var wsName = defaultWsName || 'SheetJS'
